          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-md-8 bg-white p-3 border">
                    {!! Form::open(['id' => 'editForm', 'action' => ['Auth\ShowRoomStaffControllers\ShowRoomStaffController@store'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        @csrf
                        <div class="form-row">
                        ...
                        <input id="em_pro" name="car_image_main" class="d-none" onchange="readURL(this, '#em_pro_prev')" type="file"/>
                        <div class="form-row">
                      ...
                      <div class="card card-user">
                          ...
                          <div class="card-body">
                              <div class="author">
                                ...
                                <h5 class="title text-secondary" style="letter-spacing:8px;">Profile Picture</h5>
                              </div>
                          </div>
                      </div>
                  </div>
