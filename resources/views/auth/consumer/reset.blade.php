                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('consumer.password.request') }}" aria-label="{{ __('Reset Password') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="no-outline rounded-0 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="no-outline rounded-0 form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="no-outline rounded-0 form-control" name="password_confirmation" required>
                            </div>
                        </div>
